                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="tahun_pelajaran_id" name="tahun_pelajaran_id">
                                        ...
                                        @foreach($tahunPelajarans as $tp)
                                            <option value="{{ $tp->id }}" {{ $tp->id == $tahunPelajaranId ? 'selected' : '' }}>{{ $tp->nama_tahun_pelajaran }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="tryout_id" name="tryout_id">
                                        ...
                                        @foreach($tryouts as $tryout)
                                            <option value="{{ $tryout->id }}" {{ $tryout->id == $tryoutId ? 'selected' : '' }}>{{ $tryout->nama_tryout }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
