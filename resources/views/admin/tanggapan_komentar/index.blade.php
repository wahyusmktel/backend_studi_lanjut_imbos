                        ...
                        <table class="table table-hover table-bordered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-warning btn-sm edit-tanggapan" data-id="{{ $tanggapan->id }}" data-isi="{{ $tanggapan->isi_tanggapan }}">Edit</button>
                                        <button class="btn btn-danger btn-sm delete-tanggapan" data-id="{{ $tanggapan->id }}">Hapus</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
