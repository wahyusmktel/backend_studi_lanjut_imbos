      ...
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-2 d-flex flex-column justify-content-center">
          ...
          <p data-aos="fade-up" data-aos-delay="100">Hallo Star Teacher!!!
            <br>Saatnya mengisi daftar Kehadiran di setiap Pertemuan Bimbel Studi Lanjut IMBOS.</p>
          <div class="d-flex flex-column" data-aos="fade-up" data-aos-delay="200">
            <div class="row">
              <div class="col-md-12">

                <form role="form" class="get-a-quote" id="contact-form" method="POST" action="{{ route('guru.login.submit') }}">
                  @csrf
                  <div class="group-img">
                      ...
                      <input type="text" class="form-controls" name="nip" placeholder="Masukan NIY GURU" required>
                  </div>
                  <div class="group-img">
                      ...
                      <input type="password" class="form-controls" name="password" placeholder="Masukan Password" required>
                  </div>
