    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-2 d-flex flex-column justify-content-center">
          ...
          <p data-aos="fade-up" data-aos-delay="100">Selamat datang Abi dan Umi, Yuk pantau perkembangan Putra dan Putri Abi/Umi dibawah ini</p>
              ...
              <div class="col-md-12">
                ...
                <form role="form" class="get-a-quote" id="contact-form" method="post" action="{{ route('parent.login.submit') }}">
                    ...
                    <div class="group-img">
                        ...
                        <input type="text" class="form-controls" name="nis" placeholder="Masukan NIS Siswa IMBOS" required>
                    </div>
                    <div class="group-img">
