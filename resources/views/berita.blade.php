...
<section id="hero" class="hero section">
        ...
        <div class="row gx-0">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="contents">
              ...
              <p>
                Hallo semuanya.
                Anda punya pertanyaan seputar studi Lanjut SMAIT IMBOS Pringsewu? Butuh informasi bimbel akurat? Yuk bisa Klik Tombol dibawah ini !!!
              </p>
  ...
  <section id="features" class="features section">
    ...
    <div class="container">
      ...
      <div class="row gy-2">
        ...
        <div class="col-lg-8 d-flex align-items-center">
          <div class="row align-self-center">
            ...
            <div class="text-boxs" data-aos="fade-up">
              <p>
                Kalian bisa dapetin berbagai info terkait persiapan SNBP, SNBT-UTBK, Ujian Mandiri, Ujian Kedinasan, Ujian Perguruan Tinggi Swasta, Bahkan Informasi Beasiswa, Hanya dengan pantau terus Studi Lanjut imbos lho. Juga akan share informasi terupdate seputar informasi bimbel ini. Tetap pantau ya.
              </p>
            </div>
        ...
        <div class="col-lg-4 d-flex align-items-center hidden" data-aos="zoom-out" data-aos-delay="200">
          <img src="assets/img/News-rafiki.png" class="img-fluid" alt="">
        </div>
    ...
    <img src="assets/img/front.png" alt="Ornament" class="background-ornament">
                        ...
                        <div class="post-content d-flex flex-column">
                            ...
                            <div class="meta d-flex align-items-center">
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-person"></i> <span class="ps-2">{{ $berita->author->name }}</span>
                                </div>
                                <span class="px-3 text-black-50">/</span>
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-folder2"></i> <span class="ps-2">{{ $berita->kategori->nama_kategori }}</span>
                                </div>
                            </div>
                            <hr>
                            <a href="{{ route('berita.detail', $berita->id) }}" class="readmore stretched-link"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div><!-- End post item -->
            @endforeach
