  ...
  <div class="container">
    <div class="row gy-4">
      <div class="col-lg-6 order-2 order-lg-2 d-flex flex-column justify-content-center">
        ...
        <p data-aos="fade-up" data-aos-delay="100">SMAIT Insan Mulia Boarding School adalah sekolah menengah atas yang memberikan proses pendidikan yang berkualitas dengan Kurikulum sesuai standar nasional bercirikan nilai-nilai Islam dan Al-Qur'an.</p>
        <h1 data-aos="fade-up">Studi Lanjut SMAIT IMBOS</h1>
        <p data-aos="fade-up" data-aos-delay="100">SMAIT Insan Mulia Boarding School memiliki program unggulan persiapan studi lanjut bagi siswa dan siswinya untuk melanjutkan ke jenjang Perguruan Tinggi Negeri (PTN), Perguruan Tinggi Kedinasan (PTK), Perguruan Tinggi Keagamaan Islam Negeri (PTKIN), Perguruan Tinggi Swasta(PTS) dan memiliki kerjasama program lanjut studi skala Internasional ke Turki dan Negara-Negara Timur Tengah lainnya.</p>
      </div>
      <div class="col-lg-6 order-1 order-lg-1 hero-img" data-aos="zoom-out">
        <img src="{{ asset('halaman_umum/assets/img/hero-img.png') }}" class="img-fluid animated" alt="">
      </div>
    </div>
  </div>
...
<section id="aboutfeatures" class="aboutfeatures section">
  ...
  <div class="container">
    <div class="row gy-5" data-aos="fade-up">
      <blockquote>
        <p>
          Studi Lanjut IMBOS merupakan fasilitas layanan Bimbingan Belajar Intensif untuk mempersiapkan SNBP, SNBT/UTBK, Ujian Mandiri, Persiapan Kedinasan, dengan Pembelajaran Berkualitas.
        </p>
      </blockquote>
    </div>
